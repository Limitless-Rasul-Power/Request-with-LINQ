...
namespace Responds__LINQ
{
    public static class Configuration
    {
        ...
        {
            string[] menu = {"Show All Debtors", "Show Reverse of All Debtors", "Show, domain name rhyta.com or dayrep.com people", "Show, people between age 26-36",
                "Show, people which their debt is less than or equal to 5000", "Full Name more than 18 and has at least 2 pieces 7",
            "Show people who was born in winter", "Show people which their debt is more than average people's debt",
            "Show people which their phone number didn't have 8", "Show people which their name and surname contains at least 3 same characters",
            "Show max debtor born year", "Show 5 big debtors", "Show debtors' debt sum", "Show people who see World War 2",
            "Show debtors which their phone number doesn't have same number", "Who are the debtors that pay all of their debt till their birthday ?",
            "Show people which can make \"smile\" word with their names and surnames", "Show Interval of Debtors", "Exit"};
        ...
        public static List<Debtor> GetDebtors()
        {
            List<Debtor> debtors = new List<Debtor>
            {
                ...
                new Debtor("Mezahir La. Banan", DateTime.Parse("February 29, 1932"), "123-456-7890", "Aftandil@Malakan.malapalay", "Ozu de bilmir", 1000),
                ...
                new Debtor("Anthony Robbins Energy", DateTime.Parse("February 29, 1964"), "777-777-777-777", "Life@Love.Joy.Passion", "Not Earth", 10),
